...
export class CadastroService {
    ...
    async createCliente(clienteData) {
        try {
            console.log("SERVICEEEEEEEEEEEEEEEEEEEEE",enderecoData)
    ...
    async updateCliente(id,enderecoData) {
        try {
            if (validateCPF(clienteData.cpf)) return await this.CadastroRepository.update(id,enderecoData);
        } catch (e) {
            throw e
        }
    }
