...
export function AgendarPixCola() {
    ...
    return (
        <Pagina>
            <div className="flex flex-col w-full h-screen">
                <header className="w-full h-30 bg-white flex items-center shadow-md relative z-10 px-6">
                    <div className="flex justify-between items-center w-full">
                        <NavLink to='/inicio' className="">
                            <CircleArrowLeft className="hover:text-[#cb6ce6] transition-all" />
                        </NavLink>
                ...
                <div className="hidden w-full h-64 bg-[#cb6ce6] sm:flex flex-col items-start p-10">
                ...
                <div className="w-full h-11/12 flex flex-row">
                    <div className=" hidden w- m-10 h-64 border-2 md:w-2/3 bg-[#cb6ce6] rounded-4xl p-4 sm:flex flex-col md:flex-row justify-around">
                        ...
                        <div className="w-full md:w-1/2 p-4 rounded-xl flex flex-col justify-around items-start">
                            <div className="flex flex-col w-full">
                                ...
                                <div className="flex items-center justify-between w-full mt-2">
                                    ...
                                    <button
                                        ...
                                        className="hover:text-[#cb6ce6] transition-colors cursor-pointer"
                            ...
                            <div className="flex flex-col w-full">
                                ...
                                <div className="w-full h-1 bg-[#cb6ce6] rounded-full" />
                            </div>
                        </div>
                    </div>
