...
export function Cadastro() {
  ...
  async function criarUsuario(e) {
    ...
    try {
      ...
      const enderecoResponse = await fetch("https://piprojeto.onrender.com/Enderecos", {
        method: "POST",
        headers: {
      ...
      const clienteResponse = await fetch("https://piprojeto.onrender.com/Clientes", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
      ...
      const contaResponse = await fetch("https://piprojeto.onrender.com/Contas", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
