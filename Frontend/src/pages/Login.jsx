          ...
          <div className="w-full p-5 lg:w-1/3 min-h-screen bg-[#2e2d2d] flex justify-center items-center">
            <form action="" method="" className="w-11/12 sm:w-3/4 h-11/12 md:w-2/3 lg:w-5/6 bg-white rounded-2xl flex flex-col justify-center items-center p-6 shadow-lg">
              ...
              <div className="flex flex-col">
                ...
                <input type="text" placeholder="Fulano de Tal" className=" w-60 bg-gray-100 rounded-lg p-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#6dd63a] focus:border-transparent" />  
              </div>
              <div className="flex flex-col m-5">
              <label htmlFor="" className=" p-2 w-3/4">Senha</label>
              <input type="text" placeholder="*****" className="w-60 bg-gray-100 rounded-lg p-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#6dd63a] focus:border-transparent"/>
              </div>
              <button className="m-5 w-1/2 h-10 rounded-2xl bg-[#00ec6a]">Entrar</button>
            </form>
