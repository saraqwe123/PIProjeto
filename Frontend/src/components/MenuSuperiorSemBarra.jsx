import { BadgeQuestionMarkIcon, BellIcon, MessageCircleMoreIcon, UserCircle2Icon } from "lucide-react";
import { useState } from "react";
import { useNavigate } from "react-router-dom";

export function MenuSuperiorSemBarra() {
    ...
    return (
        <>
            <div className="flex flex-col md:flex-row w-full items-center justify-between p-3 bg-[#007012]">
                ...
                <div className="text-gray-300 flex justify-around items-center w-full md:w-40 h-10">
                    <div className="rounded-full bg-white p-2">
                        <BadgeQuestionMarkIcon className="hover:text-[#6dd63a] transition-colors text-black" />
                    </div>
                    <div className="rounded-full bg-white p-2">
                        <MessageCircleMoreIcon className="hover:text-[#6dd63a] transition-colors text-black" />
                    </div>
                    <div className="rounded-full bg-white p-2">
                        <BellIcon className="hover:text-[#6dd63a] transition-colors text-black" />
                    </div>
                </div>
            </div>                    
        </>
